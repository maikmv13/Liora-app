...
('Queso', 'Lácteos, Huevos y Derivados'),
('Mantequilla', 'Lácteos, Huevos y Derivados'),
('Gulas', 'Pescadería'),
('Gambas', 'Pescadería'),
('Pollo', 'Carnicería'),
...
('Queso de cabra', 'Lácteos, Huevos y Derivados'),
('Nueces', 'Frutos Secos'),
('Pasas', 'Frutos Secos'),
...
('Queso cheddar', 'Lácteos, Huevos y Derivados'),
...
('Crema agria', 'Lácteos, Huevos y Derivados'),
...
('Nata líquida', 'Lácteos, Huevos y Derivados'),
...
('Lima', 'Frutas'),
('Manzana', 'Frutas'),
('Queso griego', 'Lácteos, Huevos y Derivados'),
...
('Queso mozzarella', 'Lácteos, Huevos y Derivados'),
('Ingredientes al gusto', 'Ingredientes al gusto'),
...
('Pecorino', 'Lácteos, Huevos y Derivados'),
...
(
    ...
    '',
    '',
    'https://images.pexels.com/photos/6941026/pexels-photo-6941026.jpeg'
),
(
    'Pisto de verduras',
...
(
    ...
    '',
    '',
    'https://images.unsplash.com/photo-1488477181946-6428a0291777?q=80&w=1001'
),
(
...
(
    ...
    '0',
    '50 minutos',
    '{"Paso 1": "Precalienta el horno a 200\u00b0C", "Paso 2": "Pela y corta la calabaza y las zanahorias en cubos grandes", "Paso 3": "Coloca el pollo en una bandeja para hornear y sazona con sal, pimienta y hierbas al gusto", "Paso 4": "A\u00f1ade la calabaza y las zanahorias a la bandeja y mezcla con un poco de aceite de oliva", "Paso 5": "Hornea durante 25-30 minutos hasta que el pollo est\u00e9 dorado y las verduras tiernas", "Paso 6": "Remueve ocasionalmente durante la cocci\u00f3n."}'::jsonb,
    '',
    '',
    'https://images.pexels.com/photos/539451/pexels-photo-539451.jpeg'
),
(
    ...
    '',
    '',
    'https://images.unsplash.com/photo-1525351484163-7529414344d8?q=80&w=1001'
),
(
...
(
    ...
    '',
    '',
    'https://images.unsplash.com/photo-1488477181946-6428a0291777?q=80&w=1002'
),
(
    'Guisantes Salteados',
...
(
    ...
    '',
    '',
    'https://images.unsplash.com/photo-1525351484163-7529414344d8?q=80&w=1002'
),
(
...
(
    ...
    '',
    '',
    'https://images.unsplash.com/photo-1488477181946-6428a0291777?q=80&w=1003'
),
(
...
(
    ...
    '',
    '',
    'https://images.unsplash.com/photo-1525351484163-7529414344d8?q=80&w=1003'
),
(
...
(
    ...
    '',
    '',
    'https://images.unsplash.com/photo-1488477181946-6428a0291777?q=80&w=1004'
),
(
...
(
    ...
    '',
    '',
    'https://images.unsplash.com/photo-1525351484163-7529414344d8?q=80&w=1004'
),
(
...
(
    ...
    '',
    '',
    'https://images.unsplash.com/photo-1488477181946-6428a0291777?q=80&w=1005'
),
(
...
(
    ...
    'https://images.unsplash.com/photo-1525351484163-7529414344d8?q=80&w=1005'
),
(
...
(
    ...
    'https://images.unsplash.com/photo-1488477181946-6428a0291777?q=80&w=1006'
),
(
...
(
    ...
    'https://images.unsplash.com/photo-1525351484163-7529414344d8?q=80&w=1006'
),
(
...
(
    ...
    '',
    '',
    'https://images.unsplash.com/photo-1488477181946-6428a0291777?q=80&w=1007'
),
(
...
(
    ...
    'https://images.unsplash.com/photo-1525351484163-7529414344d8?q=80&w=1007'
),
(
...
(
    ...
    '',
    'https://images.unsplash.com/photo-1488477181946-6428a0291777?q=80&w=1008'
),
(
...
(
    ...
    '',
    'https://images.unsplash.com/photo-1525351484163-7529414344d8?q=80&w=1008'
),
(
...
(
    ...
    '',
    '',
    'https://images.unsplash.com/photo-1488477181946-6428a0291777?q=80&w=1009'
),
(
...
(
    ...
    'https://images.unsplash.com/photo-1525351484163-7529414344d8?q=80&w=1009'
),
(
    'Sopa de Verduras',
...
(
    ...
    '',
    '',
    'https://images.unsplash.com/photo-1488477181946-6428a0291777?q=80&w=1010'
),
(
...
(
    ...
    '',
    '',
    'https://images.unsplash.com/photo-1525351484163-7529414344d8?q=80&w=1010'
),
(
...
(
    ...
    '',
    'https://images.unsplash.com/photo-1488477181946-6428a0291777?q=80&w=1011'
),
(
    'Guisantes estofados',
    'con huevo',
...
(
    ...
    '',
    '',
    'https://images.unsplash.com/photo-1525351484163-7529414344d8?q=80&w=1011'
),
(
    'Desayuno Penaparda ',
    'con fruta, frutos secos, zumo, café y fiambre',
    'desayuno',
    'Desayuno',
    4,
    '430',
...
(
    ...
    '',
    'https://images.unsplash.com/photo-1488477181946-6428a0291777?q=80&w=1012'
);
...
WITH recipe_Pollo_al_horno AS (
            SELECT id FROM recipes WHERE name = 'Pollo al horno'
        )
        INSERT INTO recipe_ingredients (recipe_id, ingredient_id, quantity, unit)
        SELECT 
            (SELECT id FROM recipe_Pollo_al_horno),
            i.id,
            ing.quantity,
            ing.unit::unit_type
        FROM (
...
WITH recipe_Desayuno_Penaparda_ AS (
            SELECT id FROM recipes WHERE name = 'Desayuno Penaparda '
        )
        INSERT INTO recipe_ingredients (recipe_id, ingredient_id, quantity, unit)
        SELECT 
            (SELECT id FROM recipe_Desayuno_Penaparda_),
            i.id,
            ing.quantity,
            ing.unit::unit_type
        FROM (
...
WITH recipe_Snack_Casa_Datrás AS (
            SELECT id FROM recipes WHERE name = 'Snack Casa Datrás'
        )
        INSERT INTO recipe_ingredients (recipe_id, ingredient_id, quantity, unit)
        SELECT 
            (SELECT id FROM recipe_Snack_Casa_Datrás),
            i.id,
            ing.quantity,
            ing.unit::unit_type
        FROM (
