            ...
            >
              <div className="flex items-center space-x-2 md:space-x-3 flex-1 min-w-0">
                ...
                <div className="flex-1 min-w-0">
                  <span className={`text-sm md:text-base block truncate ${item.checked ? 'text-gray-400 line-through' : 'text-gray-900'}`}>
                    {item.name}
                  </span>
              ...
              <span className={`text-xs md:text-sm ml-2 flex-shrink-0 ${item.checked ? 'text-gray-400' : 'text-gray-600'}`}>
