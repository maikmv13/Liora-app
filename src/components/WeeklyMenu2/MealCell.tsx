  ...
  if (menuItem) {
    return (
      <div className="h-full">
        <div className={`h-full p-3 hover:bg-white/50 transition-all duration-200 relative ${
          isCompact ? 'py-2' : ''
        }`}>
          <div className="flex items-center justify-between mb-1">
            ...
            {menuItem.recipe.calories && (
              <div className="inline-flex items-center space-x-1 bg-white/80 px-1.5 py-0.5 rounded-lg border border-rose-100">
